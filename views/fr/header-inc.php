		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="?section=">Accueil</a></li>
					<li><a href="?section=about">A propos</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Découvrir <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="?section=list_artist">Liste des artistes</a></li>
							<li><a href="?section=list_album">Liste des albums</a></li>
							<li><a href="?section=list_categories">Liste des catégories</a></li>
							<li><a href="?section=list_concerts">Liste des concerts</a></li>
						</ul>
					</li>
					
					<li><a class="btn" href="#login1">Se connecter</a></li>
