...
<div class="albumfiche">
  ...
  <div class="card" >
    <h2 class="card-title" id="cardtit">Artist card</h2>
...
<p><a class='btn btn-primary'  href='<?php echo $record["Siteweb"] ?>'/>Artist website</a></p> 

<p><a class='btn btn-primary' href='?section=list_artist_albums&id=<?php echo $_GET["id"]; ?>'/>Show all albums of this artist.</a></p>
